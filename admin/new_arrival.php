...
<div class="container">
        <h1>Upload Arrival Information</h1>

        <form action="new_arrival_process.php" method="post">
        ...
        <!-- Delete Arrival Information Section -->
        <div class="form-group">
            <form action="delete_arrival.php" method="post">
                <label for="deleteArrivalId">Arrival Title to Delete:</label>
                <input type="text" id="deleteArrivalId" name="title" required>
                <button type="submit">Delete Arrival Information</button>
            </form>
        </div>
    </div>
