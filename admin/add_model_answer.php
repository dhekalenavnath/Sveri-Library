...
<body onload="showAlert()">
    <div class="form-container">
        <form action="upload_modelanswer.php" method="post" enctype="multipart/form-data">
            <h2>Upload Model Answers</h2>
            <label for="modelAnswers">Select PDF files to upload:</label>
            <input type="file" name="files[]" id="modelAnswers" multiple>
            ...
            <input type="submit" value="Upload Model Answer" name="submit">
        </form>
    </div>
</body>
