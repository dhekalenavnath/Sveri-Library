...
<body onload="searchBooks()">
    <div class="header">
        <h1>Search for E-Journal</h1>
    </div>

    <div class="container">
        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Enter journal title...">
        ...
        <table class="results-table" id="searchResults"></table>
    </div>
    ...
    <script>
        function searchBooks() {
            ...
            xhr.open('GET', 'search_ejournal_process.php?search=' + searchTerm + '&department=' + department, true);
            xhr.send();
        }
    </script>
</body>
